...
REM
REM Generated by Vivado on Tue Mar 04 15:31:43 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj eyescan_sim_vlog.prj"
call xvlog  --incr --relax -L uvm -prj eyescan_sim_vlog.prj -log xvlog.log
